...
#早上好啊，小哥哥
cmd1 = on_command('早上好',aliases={'早安'},priority=2,block=True)
@cmd1.handle()
...
#我傻呗
cmd2 = on_command('你为什么喜欢上我',priority=2,block=True)
@cmd2.handle()
...
#晚安咯，我要去睡觉了，不然该不漂亮了
cmd3 = on_command('晚安',priority=2,block=True)
@cmd3.handle()
...
#
cmd4 = on_command('今晚到我房间来',priority=2,block=True)
@cmd4.handle()
...
#能做你女朋友吗
cmd5 = on_keyword(['单身'],priority=2,block=True)
@cmd5.handle()
...
#哎呀好的啦 小哥哥不要生气了嘛
cmd6 = on_keyword(['生气','气死我','是遇得到','服了','醉了','不高兴','不开心','好烦'],priority=2,block=True)
@cmd6.handle()
...
#你好小哥哥，需要服务吗？
cmd7 = on_command('hello',priority=2,block=True)
@cmd7.handle()
...
#不要想那么多。想太多不好
cmd8 = on_command('我总是想太多',priority=2,block=True)
@cmd8.handle()
...
#忙什么，都不知道找我聊聊天
cmd9 = on_keyword(['好忙','事情好多','事好多'],priority=2,block=True)
@cmd9.handle()
...
#才不话音视频呢，太轻浮了。
cmd10 = on_command('来视频吧',priority=2,block=True)
@cmd10.handle()
...
#我会努力的
cmd11 = on_command('你整天就玩吗',priority=2,block=True)
@cmd11.handle()
...
#我的红包呢
cmd12 = on_keyword(['红包'],priority=2,block=True)
@cmd12.handle()
...
#我这不方便接语音，打字聊行么？
cmd13 = on_command('语音吗',priority=2,block=True)
@cmd13.handle()
...
#拜拜咯，我去洗澡了。.mp3
cmd14 = on_command('待会聊',priority=2,block=True)
@cmd14.handle()
...
#叫我小仙女
cmd15 = on_command('怎么称呼你呢',aliases={'叫你什么呢','你叫什么呢','你叫啥','你的名字是什么'},priority=2,block=True)
@cmd15.handle()
...
#你好帅啊
cmd16 = on_command('我帅吗',aliases={'我长得怎么样','我好看吗'},priority=2,block=True)
@cmd16.handle()
...
#我单身啊
cmd17 = on_command('你有男朋友吗',aliases={'单身吗'},priority=2,block=True)
@cmd17.handle()
...
#你为什么会问这个问题~1.mp3
cmd18 = on_command('我和你妈掉进水里',priority=2,block=True)
@cmd18.handle()
...
cmd19 = on_command('小姐姐处CP吗',aliases={'谈恋爱吗','网恋吗','处CP吗'},priority=2,block=True)
@cmd19.handle()
...
#我的错咯。要不要道个歉？
cmd20 = on_command('都怪你',aliases={'都是你的错'},priority=2,block=True)
@cmd20.handle()
...
#我平常不喜欢语音的，很少说话.mp3
cmd21 = on_command('你很喜欢发语音吗',aliases={'你怎么总是发语音','你怎么老是发语音'},priority=2,block=True)
@cmd21.handle()
...
#我身体不舒服就别强迫我啦。.mp3
cmd22 = on_command('今晚来玩吗',aliases={'出来玩'},priority=2,block=True)
@cmd22.handle()
...
#我身体不舒服就别强迫我啦。.mp3
cmd23 = on_command('抱抱',priority=2,block=True)
@cmd23.handle()
...
cmd24 = on_command('你在想什么',priority=2,block=True)
@cmd24.handle()
...
#我最喜欢喝牛奶了 旺仔牛奶耶耶耶
cmd25 = on_command('你喜欢喝什么',aliases={'你最喜欢喝什么'},priority=2,block=True)
@cmd25.handle()
...
#油嘴滑舌的
cmd26 = on_command('你真好看',aliases={'你好漂亮','你真美'},priority=2,block=True)
@cmd26.handle()
...
cmd27 = on_command('击剑吗',aliases={'击剑嘛','来击剑'},priority=2,block=True)
@cmd27.handle()
...
#不要因为我可爱你就欺负我.mp3
cmd28 = on_command('你好可爱',aliases={'你真可爱'},priority=2,block=True)
@cmd28.handle()
...
#对对对，这是下载的.mp3
cmd29 = on_command('你这是下载的吗',aliases={'你的语音是下载'},priority=2,block=True)
@cmd29.handle()
...
#嗯嗯，你对我真好.mp3
cmd30 = on_command('我对你好吗',aliases={'我对你好不好'},priority=2,block=True)
@cmd30.handle()
...
#哇你好棒棒哦.mp3
cmd31 = on_command('我棒不棒',aliases={'厉害吧'},priority=2,block=True)
@cmd31.handle()
...
#我不信.mp3
cmd32 = on_command('我不喜欢你了',aliases={'你不好看'},priority=2,block=True)
@cmd32.handle()
...
#其实我也腼腆.mp3
cmd33 = on_command('我有点害羞',aliases={'我有点内向','我很内向'},priority=2,block=True)
@cmd33.handle()
...
#你再这样我不理你了啊.mp3
cmd34 = on_command('跳个舞',aliases={'来跳个舞'},priority=2,block=True)
@cmd34.handle()
...
#你以后要只对我一个人好.mp3
cmd35 = on_command('我喜欢你',aliases={'我稀饭你'},priority=2,block=True)
@cmd35.handle()
...
#别老色迷迷的好不好.mp3
cmd36 = on_command('欸嘿嘿',aliases={'嘿嘿'},priority=2,block=True)
@cmd36.handle()
...
#我刚刚刷抖音.mp3
cmd37 = on_command('你刚才再干什么',aliases={'你刚刚再干什么','你刚刚再干嘛'},priority=2,block=True)
@cmd37.handle()
...
#要亲亲抱抱举高高.mp3
cmd38 = on_command('要举高高吗',aliases={'要亲亲吗','要抱抱吗'},priority=2,block=True)
@cmd38.handle()
...
#只有我一个人的呢.mp3
cmd39 = on_command('你一个人在家吗',aliases={'你一个人在家嘛','你爸妈在家吗'},priority=2,block=True)
@cmd39.handle()
...
#在的呢。小哥哥。.mp3
cmd40 = on_command('在吗',aliases={'在嘛'},priority=2,block=True)
@cmd40.handle()
...
#没钱吃饭，你请我啊？.mp3
cmd41 = on_command('一起吃饭吗',aliases={'吃饭吗'},priority=2,block=True)
@cmd41.handle()
...
#主人，您在用我吗.mp3
cmd42 = on_command('召唤kaptree',priority=2,block=True)
@cmd42.handle()
...
#先说好 我不露脸.mp3
cmd43 = on_command('直播吗',priority=2,block=True)
@cmd43.handle()
...
cmd44 = on_command('别生气了',priority=2,block=True)
@cmd44.handle()
...
#为什么想骂我，小心我拉黑你.mp3
cmd45 = on_command('我想骂你',priority=2,block=True)
@cmd45.handle()
...
cmd46 = on_command('小懒猪',aliases={'你好懒'},priority=2,block=True)
@cmd46.handle()
...
cmd47= on_command('宝贝',priority=2,block=True)
@cmd47.handle()
...
#不原谅.mp3
cmd48 = on_command('你原谅我了吗',aliases={'原谅我'},priority=2,block=True)
@cmd48.handle()
...
#今晚有事,改天吧.mp3
cmd49 = on_command('今晚约吗',aliases={'今晚吃个饭','今晚一起吃饭'},priority=2,block=True)
@cmd49.handle()
...
cmd50 = on_command('我想看看',aliases={'看看照片'},priority=2,block=True)
@cmd50.handle()
